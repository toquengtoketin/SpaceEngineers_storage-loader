/* http://prismjs.com/download.html?themes=prism-twilight&languages=clike+csharp&plugins=line-highlight+line-numbers+autolinker */
    ...
    if (self.Prism) {
        ...
        for (var a in Prism.languages) {
            ...
            Prism.languages.DFS(r, function (a, r, l) {
                e.indexOf(l) > -1 && "Array" !== Prism.util.type(r) && (r.pattern || (r = this[a] = {
                    pattern: r
                }), r.inside = r.inside || {}, "comment" == l && (r.inside["md-link"] = t), "attr-value" == l ? Prism.languages.insertBefore("inside", "punctuation", {
                    "url-link": i
